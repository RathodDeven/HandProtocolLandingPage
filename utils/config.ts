export const APP_NAME = 'Hand Protocol'
...
export const INIT_PROJECTS = [
  ...
  },
  {
    ...
    by: 'Existential Zoomer',
    images: [
      'https://giveth.mypinata.cloud/ipfs/QmVpVxBuNpKjvf7UHjm17Mr1u1eN5ZgsQuxfdrHweJ5phF',
      'https://giveth.mypinata.cloud/ipfs/Qma3AyQzCP6sMmrrtc8aBgWZ7SpgMtU7mJpMrkAuWjiXdU',
      '/projects/lost-children/1.png'
    ],
    shortDescription:
